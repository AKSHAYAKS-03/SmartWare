...
public class ProductService : IProductService
{
    ...
    public ProductService(IUnitOfWork uow, ICurrentUserService currentUser, IBarcodeService barcodeService, ICacheService cacheService, ISequenceNumberGenerator sequenceNumberGenerator)
    {
        _uow = uow;
    ...
    public async Task<ProductResponseDto> CreateProductAsync(ProductCreateDto dto)
    {
        ...
        var sku = await _sequenceNumberGenerator.GenerateAsync("seq_products", "PRD");
        ...
        // 2. Auto-generate primary barcode for the new product (using generated SKU)

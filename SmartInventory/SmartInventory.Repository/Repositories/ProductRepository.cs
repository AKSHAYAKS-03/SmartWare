...
public class ProductRepository : GenericRepository<Product>, IProductRepository
{
    ...
    public async Task<PagedResult<Product>> GetPagedProductsAsync(ProductQueryParameters queryParams)
    {
        ...
        //  Text-based search on Product Name or SKU
        ...
        // valuates whether the current cumulative warehouse inventory is at or below the product's threshold
        ...
        //  filters products that have active levels in the target warehouse
